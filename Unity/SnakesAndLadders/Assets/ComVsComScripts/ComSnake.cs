...
// This class represents a snake in the Computer vs. Computer game mode
public class ComSnake : MonoBehaviour
{
    // Store the positions of the snake
    public int startPos;
    public int endPos;
    // Store the index of the snake in the specific game
    public int index;
    ...
    // This function gets (from the game controller) a new start and end position for the snake, it renderes the
    // snake on the new position and updates its positions.
    public void UpdateSnakePosition(int newStartPos, int newEndPos)
    {
        ...
        transform.localScale = new Vector3(0.3f, scaleY, 1);
    }
}